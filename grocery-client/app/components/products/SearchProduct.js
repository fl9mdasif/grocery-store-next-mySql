        ...
        <div className=''>
            <div className='flex items-center justify-center'>
                <input
                    ...
                    className='border-black text-black bg-slate-100 py-6 px-24'
                    value={searchTerm}
                        ...
                        <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
                            ...
                            <div className="p-3">
                                ...
                                <button className='btn btn-primary px-4 py-2 text-white'
                                    onClick={() => typeof window !== "undefined" ? document.getElementById(product.id).showModal() : <button>error</button>} >Details</button>

                                {/* modal plate */}
                                <dialog id={product.id} className="modal modal-bottom sm:modal-middle">

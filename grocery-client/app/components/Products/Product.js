            ...
            <div className="p-3">
                <div className="flex justify-between py-2 ">
                    ...
                    <button className='btn btn-primary px-4 py-2 text-white'
                        onClick={() => typeof window !== "undefined" ? document.getElementById('my_modal_5').showModal() : <button>error</button>} >Details</button>

                    {/* modal plate */}
                    <dialog id="my_modal_5" className="modal modal-backdrop w-full ">
                            ...
                            <section className="text-gray-600 body-font overflow-hidden">
                                <div className=" px-5 py-24 mx-auto">
                                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                                        <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={items.image} />
